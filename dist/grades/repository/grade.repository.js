...
let GradeRepository = class GradeRepository {
    ...
    async findMany() {
        return this.gradeRepository.findAndCountAll({
            attributes: {
                include: [
                    [sequelize_1.default.fn('avg', sequelize_1.default.col('grade.value')), 'avgGrade'],
                ],
            },
            group: ['product.id'],
        });
...
GradeRepository = __decorate([
    ...
    __param(0, (0, common_1.Inject)(grade_entity_1.Grade)),
